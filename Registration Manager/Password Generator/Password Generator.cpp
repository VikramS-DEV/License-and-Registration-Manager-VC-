...
// Password Generator.cpp : Defines the class behaviors for the application.
//
...
// CPasswordGeneratorApp construction
...
// The one and only CPasswordGeneratorApp object

CPasswordGeneratorApp theApp;


// CPasswordGeneratorApp initialization
...
int CPasswordGeneratorApp::ExitInstance()
{
	AfxOleTerm(FALSE);
